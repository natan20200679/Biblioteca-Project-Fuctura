...
from biblioteca.views import (login_view, register_view, dashboard, visualizar_livros, cadastrar_livro, \
                              visualizar_emprestimos, registrar_emprestimo, visualizar_usuarios, criar_usuario,
                              visualizar_relatorios, excluir_usuario, descadastrar_livro)
urlpatterns = [
